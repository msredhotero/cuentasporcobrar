...
--
-- Servidor: localhost
-- Tiempo de generación: 28-03-2016 a las 19:03:14
...
(1, 'Marcos', '16516894', 'asdamsdomo', 'msredhotero@msn.com', '15484851', '1518784', 'Daniela Ropaldo Cristina', 'Daniel Saupurein Nestor', 'Diego Menna', 'Alexandra Martinoli', 'Sargento Garcia', 'Marcos', 'aisudhasd', 'GVA', 'TUYASDADU23345', 'AOSDI89938HFASDUIF', 'Todas las noticias en tiempo real. Información, videos y fotos sobre los hechos y los protagonistas más relevantes del momento de la Argentina y el mundo.', '', 'Sanchez Ricardo', 'aosdij893u', NULL),
(2, 'uuuuuuuuuu', 'iiiii', 'uiui', 'etjej', '565y56', 'y56y56', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '5656yg56h', NULL, NULL, NULL);
...
--
-- Volcado de datos para la tabla `dbempresasbancos`
--

INSERT INTO `dbempresasbancos` (`idempresabanco`, `refempresa`, `banco`, `sucursal`, `cuenta`, `clave`, `activo`) VALUES
(1, 1, 'IXE', '7653 La Cuspide', '002-73-82-13-66', '0020-1548-7811-4767-66', NULL),
(2, 1, 'BANORTE', '1398 La Cuspide', '012-32-43-76-98', '8723-2244-5566-3674-44', NULL),
(3, 1, 'BANORTE', '1398 La Cuspide', '002-13-83-13-66', '1123-2244-5566-3674-44', NULL);
...
(20, '../usuarios/', 'icousuarios', 'Usuarios', 7, NULL, 'Administrador, Capturista'),
...
--
-- Estructura de tabla para la tabla `tbtiposocios`
--

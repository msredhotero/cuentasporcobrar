...
$titulosColumnas = array("Tipo Socio", "Nombre", "IFE","CURP", "RFC", "Domicilio");
...
$i = 4; //Numero de fila donde se va a comenzar a rellenar
 while ($fila = mysql_fetch_array($datos)) {
     $objPHPExcel->setActiveSheetIndex(0)
         ->setCellValue('A'.$i, utf8_encode($fila['tiposocio']))
         ->setCellValue('B'.$i, utf8_encode($fila['nombre']))
         ->setCellValue('C'.$i, $fila['ife'])
		 ->setCellValue('D'.$i, $fila['curp'])
         ->setCellValue('E'.$i, $fila['rfc'])
...
header('Content-Disposition: attachment;filename="rptSocios.xlsx"');

...
->setDescription("Documento Excel Saldos Clientes Empresas.")
->setKeywords("Excel Office 2007 openxml php")
->setCategory("Excel");
 
$tituloReporte = "Reporte Saldos de Clientes a Empresas";
$tituloReporte2 = "Empresa: ".strtoupper($empresa); 
$tituloReporte3 = "Fecha: ".date('Y-m-d'); 

$titulosColumnas = array("Empresas", "Cargos", "Abonos", "Saldo");
...
header('Content-Disposition: attachment;filename="rptSaldosClientesEmpresasExcel.xlsx"');
